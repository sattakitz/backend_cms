...
$totalItemsStmt = $pdo->query("SELECT COUNT(*) FROM tags");
...
$stmt = $pdo->prepare('SELECT * FROM tags ORDER BY name ASC LIMIT :limit OFFSET :offset');
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php foreach ($tags as $t): ?>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($t['name']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="delete_tag?id=<?php echo $t['id']; ?>&csrf=<?php echo e(csrf_token()); ?>" class="text-red-600 hover:text-red-900" onclick="return confirm('Are you sure you want to delete this tag?')">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
